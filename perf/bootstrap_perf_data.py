...
def _request_json(url: str, method: str = 'GET', headers: dict[str, str] | None = None, payload: dict | None = None):
...
def create_perf_seed_data(grafana_base_url: str, dashboard_hub_base_url: str, dashboard_count: int, admin_user: str, admin_password: str):
    ...
    return dashboard_uids, share_tokens


def main() -> int:
    parser = argparse.ArgumentParser(description='Bootstrap performance test dashboards and share links')
    ...
    dashboard_uids, share_tokens = create_perf_seed_data(
